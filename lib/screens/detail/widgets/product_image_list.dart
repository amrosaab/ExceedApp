  ...
  void initState() {
    ...
    if (kProductDetail.showSelectedImageVariant) {
      _subChangeSelectedVariation =
        ...
        if (image != null && imagesList.contains(image)) {
          _carouselController.animateToPage(imagesList.indexOf(image));
        }
      });
    }
  }
            ...
            children: [
              Positioned.fill(
                  ...
                  child: CarouselSlider(
                    ...
                    items: itemList.mapIndexed((index, i) {
                      return Builder(
