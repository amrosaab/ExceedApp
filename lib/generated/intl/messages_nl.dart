...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m17(currency, amount) =>
      "Het minimumbedrag voor het gebruik van deze betaling is {${currency}} {${amount}}";

  static String m18(minute) => "${minute} minuten geleden";

  static String m19(month) => "${month} maanden geleden";

  static String m20(store) => "Meer van ${store}";

  static String m21(itemCount) => "${itemCount} items";

  static String m22(price) => "Opties totaal: ${price}";

  static String m23(total) => "Aantal: ${total}";

  static String m24(percent) => "Verkoop ${percent} %";

  static String m25(second) => "${second} seconden geleden";

  static String m26(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m27(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m28(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m29(total) => "${total} producten";

  static String m30(date) => "Geldig tot ${date}";

  static String m31(message) => "Waarschuwing: ${message}";
  ...
  static String m33(length) => "We hebben ${length} producten gevonden";

  static String m34(week) => "Week ${week}";

  static String m35(name) => "Welkom ${name}";

  static String m36(year) => "${year} jaar geleden";

  static String m37(total) => "Je hebt toegewezen aan bestelling #${total}";
